...
controller_filepath = os.path.join(pkg_share_filepath, "config", "diff_drive_controller.yaml")
...
def generate_launch_description():
    ...
    # Diff Drive Controller activado para moverse como modelo diferencial
